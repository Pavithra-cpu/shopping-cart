...
<%
   List<String> item = (ArrayList<String>) request.getAttribute("itemname");
   List<Integer> price = (ArrayList<Integer>) request.getAttribute("price");
   int slnumber=1;
   int i;
    ...
    for(i=0;i<item.size();i++)
    {
     ...
     <td>
       ...
       <form action="Writeitem" method="get">
         <input type="hidden" name="it" value="<%=item.get(i)%>"/>
      ...
      <form action="Deleteitem" method="get">
        <input type="hidden" name="itt" value="<%=item.get(i)%>"/>
