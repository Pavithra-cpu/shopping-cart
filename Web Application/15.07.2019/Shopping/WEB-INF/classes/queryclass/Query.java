...
public class Query{
  ...
  public List<Items> searchItems(String query)throws SQLException{
    List<Items> items = new ArrayList<Items>();
    Statement pstmt = null;
    try{
      pstmt = con.createStatement();
      //String query = "SELECT * FROM items WHERE "+attribute1+" "+constraint1+" ? "+condition+" "+attribute2+" "+constraint2+" ?";
      //pstmt = con.prepareStatement(query);
